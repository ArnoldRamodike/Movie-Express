// Generated 08 Nov 2021 10:29 - Singular Systems Object Generator Version 2.2.694
//<auto-generated/>
using System;
using Csla;
...
namespace MELib.Transactions
{
    ...
    public class TransactionItem
     : MEBusinessBase<TransactionItem>
    {
        #region " Properties and Methods "

        #region " Properties "

        public static PropertyInfo<int> TransactionNameIDProperty = RegisterProperty<int>(c => c.TransactionNameID, "ID", 0);
        /// <summary>
        /// Gets the ID value
        /// </summary>
        [Display(AutoGenerateField = false), Key]
        public int TransactionNameID
        {
            get { return GetProperty(TransactionNameIDProperty); }
        }

        public static PropertyInfo<int?> MovieIDProperty = RegisterProperty<int?>(c => c.MovieID, "Movie", null);
        /// <summary>
        ...
        {
            return GetProperty(TransactionNameIDProperty);
        }
        ...
        protected void Fetch(SafeDataReader sdr)
        {
            ...
            {
                int i = 0;
                LoadProperty(TransactionNameIDProperty, sdr.GetInt32(i++));
                LoadProperty(MovieIDProperty, Singular.Misc.ZeroNothing(sdr.GetInt32(i++)));
        ...
        protected override Action<SqlCommand> SetupSaveCommand(SqlCommand cm)
        {
            ...
            AddPrimaryKeyParam(cm, TransactionNameIDProperty);
    ...
    if (this.IsNew)
                {
                    LoadProperty(TransactionNameIDProperty, scm.Parameters["@TransactionNameID"].Value);
                }
            };
        }
        ...
        {
            cm.Parameters.AddWithValue("@TransactionNameID", GetProperty(TransactionNameIDProperty));
        }
