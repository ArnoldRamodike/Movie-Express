...
namespace MELib.Products
{
     ...
     : MEBusinessListBase<ProductList, Product>
    {
          ...
          : CriteriaBase<Criteria>
        {
            ...
            public Criteria(int? CategoryID, int? ProductID)
            {
        ...
        public static ProductList GetProductList(int? CategoryID, bool IsActiveInd)
        {
            return DataPortal.Fetch<ProductList>(new Criteria() { CategoryID = CategoryID, IsActiveInd = IsActiveInd });
        }
            ...
            using (SqlConnection cn = new SqlConnection(Singular.Settings.ConnectionString))
            {
                ...
                try
                {
                    using (SqlCommand cm = cn.CreateCommand())
                    {
                        ...
                        cm.Parameters.AddWithValue("@CartegoryID", Singular.Misc.ZeroDBNull(crit.CategoryID));
