...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
  ...
  <script type="text/javascript">
    ...
    var RentMovie = function (obj) {
          ViewModel.CallServerMethod('RentMovie', { MovieID: obj.MovieID(), movieList: ViewModel.MovieList.Serialise(), ShowLoadingBar: true }, function (result) {
        if (result.Success) {
          //  window.location = result.Data;
            alert('Movie Purchased Succefully');
            window.location = '../Movies/Movie.aspx?';
        }
        else {
